...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<ICustomerGroupRepository, EfCustomerGroupRepository>();
        services.AddScoped<ISupplierRepository, EfSupplierRepository>();
        services.AddScoped<ISupplierItemRepository, EfSupplierItemRepository>();
        services.AddScoped<ISupplierGroupRepository, EfSupplierGroupRepository>();
        ...
        services.AddScoped<IUomClassRepository, EfUomClassRepository>();
        ...
        services.AddScoped<IItemGroupRepository, EfItemGroupRepository>();
