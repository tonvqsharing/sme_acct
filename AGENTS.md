...
```bash
uv run pytest -q                                  # full suite (currently 385 passing)
...
| Bank/Cash Accounts | ✅ core done — bank+cash masters, balances, balances auto-move with vouchers (5 link tests); reconciliation pending | `docs/bank-cash/` |
