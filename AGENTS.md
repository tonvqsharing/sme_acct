...
```bash
uv run pytest -q                                  # full suite (currently 380 passing)
...
| Bank/Cash Accounts | ✅ core done — bank+cash masters, balances, SOD-lite guards (24 tests); reconciliation pending | `docs/bank-cash/` |
