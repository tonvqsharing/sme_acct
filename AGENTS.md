...
```bash
uv run pytest -q                                  # full suite (currently 279 passing)
...
| Chart of Accounts | ✅ core done — TT200/TT133 codes, hierarchy, posting gate (21 tests); storage+API pending | `docs/coa/` |
